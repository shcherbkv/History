...
const sections = {
  ...
  'perun-sanctuary':           { title: 'Святилище Перуна',                                                            template: 'pages/culture/architecture/perun-sanctuary.html', parent: 'architecture' },
  'arch-kiev-kapishche':       { title: 'Киевское капище князя Владимира',                                             template: 'pages/culture/architecture/kiev-kapishche.html',  parent: 'architecture' },
  'arch-zmievy-valy':          { title: 'Змиевы валы',                                                                 template: 'pages/culture/architecture/zmievy-valy.html',     parent: 'architecture' },
  'arch-vasily-church':        { title: 'Церковь Святого Василия в Киеве',                                             template: 'pages/culture/architecture/vasily-church.html',   parent: 'architecture' },
  'arch-dubovaya-sofia':       { title: 'Дубовая София в Новгороде',                                                   template: 'pages/culture/architecture/dubovaya-sofia.html',  parent: 'architecture' },
  'arch-desyatinnaya':         { title: 'Десятинная церковь в Киеве',                                                  template: 'pages/culture/architecture/desyatinnaya.html',    parent: 'architecture' },

  // Архитектура — крепости
  'arch-staraya-ladoga':       { title: 'Старая Ладога',                                                                template: 'pages/culture/architecture/staraya-ladoga.html', parent: 'architecture' },
  'arch-izborsk':              { title: 'Изборск',                                                                      template: 'pages/culture/architecture/izborsk.html',        parent: 'architecture' },
  'arch-iskorosten':           { title: 'Искоростень',                                                                  template: 'pages/culture/architecture/iskorosten.html',     parent: 'architecture' },
  'arch-rodnya':               { title: 'Родня (Родень)',                                                               template: 'pages/culture/architecture/rodnya.html',         parent: 'architecture' },
  'arch-belgorod':             { title: 'Белгород (Белгород-Киевский)',                                                 template: 'pages/culture/architecture/belgorod.html',       parent: 'architecture' },
  'arch-pereyaslavl':          { title: 'Переяславль (Переяславль-Русский)',                                            template: 'pages/culture/architecture/pereyaslavl.html',    parent: 'architecture' },
  'arch-sarkel':               { title: 'Саркел (Белая Вежа)',                                                          template: 'pages/culture/architecture/sarkel.html',         parent: 'architecture' },
  'arch-chersones':            { title: 'Херсонес (Корсунь)',                                                           template: 'pages/culture/architecture/chersones.html',      parent: 'architecture' },
  'arch-dorostol':             { title: 'Доростол',                                                                     template: 'pages/culture/architecture/dorostol.html',       parent: 'architecture' },
  'arch-ovruch':               { title: 'Овруч',                                                                        template: 'pages/culture/architecture/ovruch.html',         parent: 'architecture' },

  // Архитектура — города
  'arch-novgorod':             { title: 'Новгород',                                                                     template: 'pages/culture/architecture/novgorod.html',        parent: 'architecture' },
  'arch-rostov':               { title: 'Ростов',                                                                       template: 'pages/culture/architecture/rostov.html',          parent: 'architecture' },
  'arch-chernigov':            { title: 'Чернигов',                                                                     template: 'pages/culture/architecture/chernigov.html',       parent: 'architecture' },
  'arch-murom':                { title: 'Муром',                                                                        template: 'pages/culture/architecture/murom.html',           parent: 'architecture' },
};
